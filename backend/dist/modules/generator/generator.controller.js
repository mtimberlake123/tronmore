...
let GeneratorController = class GeneratorController {
    ...
    async generate(req, body) {
        const data = await this.generatorService.generate(req.user.tenantId, body.merchant_id, body.type, body.options || {});
        return {
            code: 200,
            data,
        };
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], GeneratorController.prototype, "getGenerations", null);
__decorate([
    (0, common_1.Post)('generations/:id/feedback'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object]),
    __metadata("design:returntype", Promise)
], GeneratorController.prototype, "feedback", null);
