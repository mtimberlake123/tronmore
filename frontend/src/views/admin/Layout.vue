...
import { Grid, OfficeBuilding, Document, Warning, Moon, Sunny, Promotion, MagicStick, Setting } from '@element-plus/icons-vue'
...
const menuItems = [
  ...
  { path: '/admin/ai-provider', name: '接口配置', icon: Setting }
]
